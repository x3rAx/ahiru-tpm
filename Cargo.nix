...
let
  nixifiedLockHash = "eb127ea6f483c2a54d1b98fe2fda97b485957bc97d1f72331066f0dc039d05a2";
...
in
{
  ...
  workspace = {
    tpm-rs = rustPackages.unknown.tpm-rs."0.4.0";
  };
  ...
  "unknown".tpm-rs."0.4.0" = overridableMkRustCrate (profileName: rec {
    name = "tpm-rs";
    version = "0.4.0";
    registry = "unknown";
